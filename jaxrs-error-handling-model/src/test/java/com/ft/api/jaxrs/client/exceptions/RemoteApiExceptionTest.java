...
public class RemoteApiExceptionTest {
    ...
    public void shouldUseMessageFromServerWhenAvailable() {
        RemoteApiException example = new RemoteApiException(exampleUri(),"GET",500,new ErrorEntity(EXAMPLE_MESSAGE));
    ...
    public void shouldHaveAMessageEvenWhenServerMessageIsMissing() {
        RemoteApiException example = new RemoteApiException(exampleUri(),"GET",500,new ErrorEntity(null));
