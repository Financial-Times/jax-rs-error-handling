...
/**
 * Thrown when the server accepts responsibility for the failure of an HTTP transaction.
 *
 * <p>The server may accept the responsibility for a failure when it is unclear where fault lies, or
 * to be diplomatic.
 *
 * @author Simon.Gibbs
 */
